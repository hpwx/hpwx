package com.hp.wxtoken.controller;
...
import com.hp.wxtoken.WxValidateApplication;

import util.SecrutiyUtil;

public class WxTokenValiteController {
	@Value(value="${wx.token}")
    private     String TOKEN;
	
	Logger LOG=LoggerFactory.getLogger(WxValidateApplication.class);
