...
public class DateUtil {
	...
	private static long MILLISECOND_OF_YEAR = 31536000000L;
	...
	public static int getDiffYears(Date beginDate, Date endDate) {
		...
		long diff = (endDate.getTime() - beginDate.getTime()) / MILLISECOND_OF_YEAR;


		int year = new Long(diff).intValue();
	...
	public static int daysBetween(Date smdate,Date bdate) throws ParseException{
		...
		String smdateStr = sdf.format(smdate);
		String bdateStr = sdf.format(bdate);
		smdate = sdf.parse(smdateStr);
		bdate = sdf.parse(bdateStr);
		Calendar cal = Calendar.getInstance();    
		cal.setTime(smdate);    
